...
# folder = 'input_files/sparky-0_falcon-h/TFrecords/TFrecords_testbed_fh_test_8trials_batchsize4/'
# folder = 'input_files/sparky-0_falcon-h/TFrecords/TFrecords_testbed_fh_train_10trials_batchsize4/'
# folder = 'input_files/sparky-0_falcon-h/TFrecords/TFrecords_s0_batchsize4/'

# folder = 'input_files/sparky-0/TFrecords/TFrecords_s0_train7_non-zi_batchsize4/'

folder = 'input_files/grid_level/s0fe/TFrecords/TFrecords_testbed_fe_test_9trials_batchsize4/'
# folder = 'input_files/grid_level/s0fe/TFrecords/TFrecords_s0_batchsize4/'
# folder = 'input_files/room_level/fhfm/TFrecords/TFrecords_testbed_fm_train_10trials_batchsize4/'

# folder = 'input_files/reverse/s0fe/TFrecords/TFrecords_testbed_fe_train_10trials_batchsize4/'
# folder = 'input_files/reverse/s0fe/TFrecords/TFrecords_s0_test_2trials_batchsize4/'
...
def main(args):
    with open(args.config_filename) as f:
        ...
        np.save(folder + 'scaler.npy', np.array([scaler.mean, scaler.std]))
