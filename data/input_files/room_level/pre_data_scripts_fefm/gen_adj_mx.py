...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='room_level/fefm/fefm_graph_sensor_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='room_level/fefm/distances_fefm.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='room_level/fefm/fefm_adj_mat.pkl',
