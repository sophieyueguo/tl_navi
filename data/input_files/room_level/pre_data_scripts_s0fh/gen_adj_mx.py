...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='sparky-0_falcon-h/s0fh_graph_sensor_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='sparky-0_falcon-h/distances/distances_s0fh.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='sparky-0_falcon-h/s0fh_adj_mat.pkl',
