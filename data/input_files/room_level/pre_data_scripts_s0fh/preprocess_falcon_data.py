...
h5_path = 'transfer_learning/TL-DCRNN-master/data/input_files/sparky-0_falcon-h/h5/'
max_trail_count = 10
h5_name = 'testbed_fh_train_' + str(max_trail_count) + 'trials'
# h5_name = 'testbed_fh_test_' + str(max_trail_count) + 'trials'
