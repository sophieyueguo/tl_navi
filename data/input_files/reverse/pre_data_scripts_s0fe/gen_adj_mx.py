...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='s0fe/s0fe_graph_sensor_ids.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='s0fe/distances/distances_s0fe.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='s0fe/s0fe_adj_mat.pkl',
