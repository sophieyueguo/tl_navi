...
# train_trial = [2, 3, 4, 5, 6, 7]
train_trial = [2]
test_trial = [0, 1]
# distance_path = 'transfer_learning/TL-DCRNN-master/data/input_files/falcon/distances/distances_falcon_hard.csv'
h5_path = 'transfer_learning/TL-DCRNN-master/data/input_files/reverse/s0fe/h5/'
h5_name = 's0_train_' + str(len(train_trial)) + 'trials'
# h5_name = 's0_test_2trials'
...
if __name__ == '__main__':
    ...
    for txtfile in txtfiles:
        if '_0' in txtfile:
            # if trial in test_trial:
            if trial in train_trial:
