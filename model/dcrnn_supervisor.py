...
# save_path = 'data/results/reverse/s0fe/batchsize4/trainval-fe_test-s02trials/'
# save_path = 'data/results/reverse/s0fe/batchsize4/nonsavedmodel-fe_trainval-s01trials_test-s02trials/'

# save_path = 'data/results/room_level/fefm/batchsize4/savedmodel-fm_trainval-fe6trials_test-fe9trials/'
# save_path = 'data/results/room_level/fhfm/batchsize4/trainval-fm_test-fh8trials/'
# save_path = 'data/results/room_level/s0fe/batchsize4/nonsavedmodel-s0_trainval-fm8trials_test-fm7trials/'
# save_path = 'data/results/room_level/s0fe/batchsize4/nonsavedmodel-s0_trainval-fm10trials_test-fm7trials/'
# save_path = 'data/results/room_level/sparky-0/batchsize4/s0_train7_non-zi_batchsize4_testonzi/'
# save_path = 'data/results/grid_level/s0fe/batchsize4/trainval-s0_test-fe9trials/'
save_path = 'data/results/grid_level/s0fe/batchsize4/nonsavedmodel-s0_trainval-fe6trials_test-fe9trials/'

test_loss_all_path = save_path + 'test_loss_all.npy'
runtime_all_path = save_path + 'runtime_all.npy'
MODEL_FILENAME = None

# MODEL_FILENAME = 'data/model_32t/grid_level_fes0/models-0.0000-68816'

# MODEL_FILENAME = 'data/model_32t/reverse_s0fe/models-0.0000-66912'
# MODEL_FILENAME = 'data/model_32t/reverse_s0fm/models-0.0000-64640'
# MODEL_FILENAME = 'data/model_32t/reverse_s0fh/models-0.0000-66924'

# MODEL_FILENAME = 'data/model_32t/room_level_fhfm/models-0.0000-88880'
# MODEL_FILENAME = 'data/model_32t/room_level_fefm/models-0.0000-96960'

# MODEL_FILENAME = 'data/model_32t/grid_level_fes0_nonstart_trainval-s0_test-fe/models-0.0334-71808'
# MODEL_FILENAME = 'data/model_32t/grid_level_fhs0_nonstart_trainval-s0_test-fh/models-0.0334-71808'
# MODEL_FILENAME = 'data/model_32t/grid_level_fms0_nonstart_trainval-s0_test-fm/models-0.0334-71808'

# MODEL_FILENAME = 'data/model_32t/fhs0_nonstart_trainval-s0_test-fh/models-0.0000-81600'
# MODEL_FILENAME = 'data/model_32t/fes0_nonstart_trainval-s0_test-fe/models-0.0000-79968'
# MODEL_FILENAME = 'data/model_32t/fms0_nonstart_trainval-s0_test-fm/models-0.0000-81600'
...
class DCRNNSupervisor(object):
    ...
    def _train(self, sess, base_lr, epoch, steps, patience=50, epochs=100,
        ...
        # model_filename = 'data/model_32t/model_s0train/models-0.0001-588'
        ...
        if model_filename is not None:
            ...
            self._epoch = epoch + 1
            print ('this is a saved model!!!!!!!!!')
            # print('validation loss', val_loss)
        else:
            print ('model filename is none!!!!!!!!!!!!!!')
        ...
        while self._epoch <= epochs:
            ...
            runtime_all.append(end_time - start_time)
            np.save(runtime_all_path, np.array(runtime_all))

            # modify to compute the horizon prediction, this is in the original DCRNN code
            test_every_n_epochs = 1
            if self._epoch % test_every_n_epochs == test_every_n_epochs - 1:
                y_preds_all, test_loss = self.evaluate(sess)
                # print ('epoch', self._epoch, 'test loss mean', test_loss_mean, 'test loss std', test_loss_std)
                test_loss_all.append([test_loss])
                np.save(test_loss_all_path, np.array(test_loss_all))
    ...
    def evaluate(self, sess, **kwargs):
        ...
        for cluster in sclusters:
            ...
            test_loss_list.append(test_results['loss'])
        ...
        return y_preds_all, test_loss_list
