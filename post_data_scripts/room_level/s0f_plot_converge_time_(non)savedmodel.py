...
ind = np.arange(MAX_NUM_FALCON_INPUT)
fig, ax = plt.subplots(figsize=(7, 4))
# np.save('post_data_scripts/grid_level/room_level_converge_time_savedmodel', avg_ys_1[True])
# np.save('post_data_scripts/grid_level/room_level_converge_time_nonsavedmodel', avg_ys_1[False])
# print (list(avg_ys[True]) + list(avg_ys[False]))
