...
# MAP_ABBR = 'e'
    ...
    # DOES_TRAIN_FROM_SAVED_MODEL = True
        ...
        f_PATH_2 = 'trials_test-s02trials/'
...
df = pd.DataFrame({'Number of Finetuning Trajectories': list(ind+1) + list(ind+1), \
                    'Type': ['With finetuning (use pre-trained model with 3 Falcon Map Data)']* len(ind) + ['Trained from Scratch']*len(ind),\
